...
public class WeiboLoadingFooterView extends RefreshFooterLayout implements OnScrollListener, OnLoadListener {

    private TextView tvMessage;
    private LoadingView loadingView;

    public WeiboLoadingFooterView(Context context) {
        this(context, null);
    }

    public WeiboLoadingFooterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeiboLoadingFooterView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        inflate(context, R.layout.view_weibo_loading_footer, this);
        tvMessage = findViewById(literefresh.widget.R.id.tv_message);
        loadingView = findViewById(literefresh.widget.R.id.loading_view);
    }
    ...
    public void onLoadComplete(@Nullable Throwable throwable) {
        ...
        if (throwable != null) {
            ...
            tvMessage.setText(literefresh.widget.R.string.loading_complete);
        }
    }
}
